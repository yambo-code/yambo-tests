...
if ( $LIFE=="1" or ( $GW=="1" and $EM1D=="1" ) or ($COHSEX=="1" and $COLL=="0") or ($COHSEX=="1" and $COLL=="1" and $EM1S=="0") ) { 
 foreach $f1 (@QSB){ foreach $f2 (@GQKCV){ 
  $Nr++;
  $MPI_CPU_conf[$Nr]="SE_CPU=\"@$f1[0].@$f1[1].@$f1[2]\" X_all_q_CPU=\"@$f2[0].@$f2[1].@$f2[2].@$f2[3].@$f2[4]\" DIP_CPU=\"@$f1[1].@$f1[2].@$f1[3]\"";
 }}
 return;
}
#
...
if ($GW=="0" and $EM1S=="1" and $BSE=="0" and $COLL=="0") { 
 foreach $f1 (@GQKCV){
  $Nr++;
  $MPI_CPU_conf[$Nr]="X_all_q_CPU=\"@$f1[0].@$f1[1].@$f1[2].@$f1[3].@$f1[4]\" DIP_CPU=\"@$f1[1].@$f1[2].@$f1[3]\"";
 }
 return;
}
#
...
if ($BSE=="1" and $EM1S=="1" ) { 
 foreach $f1 (@GQKCV){ foreach $f2 (@KEHT){
  $Nr++;
  $MPI_CPU_conf[$Nr]="X_all_q_CPU=\"@$f1[0].@$f1[1].@$f1[2].@$f1[3].@$f1[4]\" BS_CPU=\"@$f2[0].@$f2[1].@$f2[2]\" DIP_CPU=\"@$f1[1].@$f1[2].@$f1[3]\"";
...
if ($EM1S=="1" and $COLL=="1" and $yambo_exec=~"yambo_rt") { 
 foreach $f1 (@GQKCV){ foreach $f2 (@QKSB){
  $Nr++;
  $MPI_CPU_conf[$Nr]="X_all_q_CPU=\"@$f1[0].@$f1[1].@$f1[2].@$f1[3].@$f1[4]\" RT_CPU=\"@$f2[0].@$f2[1].@$f2[2].@$f2[3]\" DIP_CPU=\"@$f1[1].@$f1[2].@$f1[3]\"";
 }}
 return;
}
#
