...
# Local CUDA library is /opt/pgi/linux86-64/2019/cuda/10.2


YAMBO_LIBS="/data/shared/yambo-libs/std-netcdf"
#YAMBO_LIBS="/data/shared/yambo-libs/lapack-test"
...
#mpicc=/opt/pgi/mpich/bin/mpicc
#mpif90=/opt/pgi/mpich/bin/mpif90
...
./configure \
--enable-open-mp  \
CPP="gcc -E" FPP="gfortran -E -P -cpp" \
CC=pgcc F77=pgfortran FC=pgfortran MPICC=$mpicc MPIFC=$mpif90 \
FCFLAGS="-O2 -C -g -fast -Munroll -Mnoframe -Mdalign -Mbackslash -Mbounds" \
