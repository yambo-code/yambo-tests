...
call add_RULE("-eps_along_E","skip",COLS=(/3,4,6,7/),MATERIAL="hBN LiF AlAs MoS2 WSe2 H2 Si_bulk")
call add_RULE("-eels_along_E","skip",COLS=(/3,4,6,7/),MATERIAL="hBN LiF AlAs MoS2 WSe2 H2 Si_bulk")
